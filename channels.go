...
var channelsIDs = []string{
	"UC30ditU5JI16o5NbFsHde_Q", // DW arabic
	"UC65F33K2cXk9hGDbOQYhTOw", // extra news
	...
	"UCahpxixMCwoANAftn6IxkTg", // alarabia
	"UCdTyuXgmJkG_O8_75eqej-w", // france 24
	...
	"UCZTLU39XbfN04FBXVc0vD1g", // Nickelodeon Arabia
}
